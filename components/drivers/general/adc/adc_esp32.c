...
// static const adc_channel_t channel = ADC_CHANNEL_1; //GPIO35 if ADC1
// static const adc_bits_width_t width = ADC_WIDTH_BIT_12;
// #elif defined(TARGET_MCU_ESP32S2)
// static const adc_channel_t channel = ADC_CHANNEL_1;     // GPIO2 if ADC1
// static const adc_bits_width_t width = ADC_WIDTH_BIT_12;
// #elif defined(TARGET_MCU_ESP32S3) 
static const adc_channel_t channel = ADC_CHANNEL_1;     // GPIO2 if ADC1
static const adc_bits_width_t width = ADC_WIDTH_BIT_12; // maybe wrong
// #endif
